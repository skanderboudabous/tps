...
export class LayoutComponent implements OnInit {
  ...
  isConnected() {
    return this.userService.currentUser.value != null || localStorage.getItem("token")!=null;
  }
  ...
  ngOnInit() {
    ...
    else if(this.userService.currentUser.subscribe((user)=>{
      if(user!=null)
      {
        this.userService.initRoutes(user.role);
      }
      else{
